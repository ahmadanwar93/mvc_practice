        ...
        <div class="app__wrapper">
            ...
            <form action='../controller/controllerIndex.php' method='post'>
                ...
                <div class="form_app_submit_container">
                    <button class="form_app_submit btn_blue" onclick="location.href='../controller/controllerIndex.php';" type="submit">Next <span class="next_arrow_icon"><img src="dist/images/svg/arrow_right_white.svg" alt=""></span></button>
                </div>
            </form>
        </div>
    </div>
