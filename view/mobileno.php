...
<body>
    ...
    <div class="app__container">
        <div class="app__wrapper">
            ...
            <form action='../controller/controllerMobile.php' method='post'> 
                <input id="phone" name="phone" type="tel">
                <div class="form_app_submit_container">
                    <button type="submit" class="form_app_submit btn_blue" onclick="location.href='../controller/controllerMobile.php';">Verify <span class="next_arrow_icon"><img src="dist/images/svg/arrow_right_white.svg" alt=""></span></button>
                </div>
            </form>
        </div>
