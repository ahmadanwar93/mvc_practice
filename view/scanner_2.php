...
<head>
    ...
    <?php
        include '../controller/controllerScanner.php';
...
<body class="app__card">
    <!-- <?php
        ...
        <?php
            ...
            // echo $phoneUser;
            // session_start();
            // $_SESSION['checkInComp'] = $_POST['checkinCompany'];
                    ...
                    <div class="card_scanner_front">
                        <div class="top_camera_placeholder">
                            <div class='dropdownMenu'>
                                <form action='../view/scanner_2.php' method='post'>
                                    <label for='checkinComp'>Select which place are you currently want to check in? </label>
                                <?php
                                    echo "<select name='checkinCompany' id='checkinCompany'>";
                                    $i = 0;
                                    while($i < count($row_compDropDown)){
                                        echo "<option value='{$row_compDropDown[$i]["company_id"]}'>{$row_compDropDown[$i]['company_name']}</option>";  
                                        $i++;
                                    }
                                    echo "</select>";                         
                                ?>
                        ...
                        <div class="activity_calendar_listing_container">
                            ...
                            <div class="calendar_rows_container">
                                <?php 
                                    ...
                                    while($i < count($row_companyInfo)){
                                        
                                        echo "
                                        <div class='calendar_row'>
                                            <div class='calendar_company'>{$row_companyInfo[$i]['company_name']}</div>                         
                                            <div class='calendar_branch'>{$row_companyInfo[$i]['company_branch']}</div>
                                            <div class='calendar_date'>{$row_companyInfo[$i]['checkin_date_created']}</div> 
